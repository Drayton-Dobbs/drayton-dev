  ...
  return (
    <div className="text-white">
      ...
      <p className="tracking-wide text-gray-500 px-6">
        ...
        graphs, schedules. I just found it all so neat.
        {/* In particular, a
      ...
      <p className="tracking-wide text-gray-500 px-6">
        ...
        . The class would be 9-5, 40 hours a week for 4 months. I was already
        serving at a high end resturaunt 40 hours a week. If I were to take on
        the coding bootcamp, it would mean switching my current work schedule to
        nights and coding during the day. I decided to take on this challenge.
        Financial gain was my main reason for exploring this industry until I
        eventually (as soon as I learned CSS) found a love for designing
        well-made responsive apps.
      </p>{" "}
      <div className="flex justify-start">
        <div className="mx-6 border-b w-1/12 my-4"></div>
      </div>
